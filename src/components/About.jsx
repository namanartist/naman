            ...
            <div className="relative z-[50] w-full lg:w-[80%] flex flex-col md:flex-row items-center justify-end">
                ...
                <div className="w-full lg:w-[65%] flex flex-col space-y-6 md:space-y-10 pointer-events-auto bg-white/60 dark:bg-black/40 backdrop-blur-sm p-6 md:p-12 border border-black/5 dark:border-white/5 rounded-2xl shadow-xl dark:shadow-none">
                    ...
                    <div className="robotic-section">
                        <p className="text-gray-600 dark:text-gray-400 text-sm md:text-md lg:text-xl font-light leading-relaxed max-w-2xl">
                            {bio}
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-5">
                            {tools.map((tool) => (
                                <div key={tool.title} className="group relative p-4 bg-white/80 dark:bg-black/50 border border-black/5 dark:border-white/5 hover:border-blue-500/50 transition-all rounded-xl flex items-center justify-center cursor-help shadow-sm dark:shadow-none">
