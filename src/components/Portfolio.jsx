    ...
    <section id="projects" className="bg-[#020202] py-24 px-6 md:px-12 lg:px-24">
      <div className="max-w-7xl mx-auto text-center mb-20">
        ...
        <motion.h2
          ...
          className="text-fluid-h2 font-black text-white mb-8 uppercase tracking-tighter"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
        {projects.map((project, index) => (
          ...
          >
            <div className="relative overflow-hidden aspect-video md:aspect-[4/3] rounded-[1.5rem] m-2">
              <img
                src={project.image}
                alt={project.title}
